...
dff = engineLoadDFF("models/swburbhaus03.dff")
engineReplaceModel(dff, 3308)
col = engineLoadCOL("models/swburbhaus03.col")
engineReplaceCOL(col, 3308)
